import { Brain, Code2, Globe, Github, Linkedin, MessageCircle, Twitter, Lightbulb, Server } from "lucide-react"

// Personal Information - EXACT from your resume
export const personalInfo = {
  name: "Chukwuebuka Chukwu",
  title: "Software Engineer & Founder",
  tagline: "Building scalable backend solutions and clean energy innovations",
...
export const projects = [
  {
    ...
    description: "Built the backend for a solar energy platform using Node.js, Express, and MongoDB.",
    problem: "Built the backend for a solar energy platform using Node.js, Express, and MongoDB.",
    features: [
    ...
    stack: ["Node.js", "Express", "MongoDB", "V0.dev", "REST APIs","React","Tailwind"],
    github: "https://github.com/davidchukwu202",
    demo: "https://v0-dec-tech.vercel.app/",
    preview:  "https://image.thum.io/get/width/800/crop/768/https://v0-dec-tech.vercel.app",
    icon: Lightbulb,
    featured: true,
    status: "completed",
    year: "2025",
  },
  {
    ...
    preview: "https://image.thum.io/get/width/800/crop/768/https://cue-nine.vercel.app/",
    icon: Globe,
    featured: true,
    status: "completed",
    year: "2024",
...
export const skillCategories = {
  "Programming Languages": ["Javascript(ES6+)", "Typescript", "JSON"],
  "Backend Development": [
    "Node.js",
    "Express.js",
    "REST API Design",
  ...
  "AI & System Integration": ["OpenAI API", "AI-driven ticketing system", "Modular service-controller design"],
  "Testing and Tools": ["Postman", "API Testing", "Console Debugging", "Error Handling"],
...
export const skills = Object.entries(skillCategories).flatMap(([category, skillList]) =>
  skillList.map((skill) => ({
    name: skill,
